...
"""18_2j-opengl_objekty.py: OpenGL v3.3 - umiestnenie do sveta niekolkych kopii toho isteho objektu"""
...
objekty = [ pyrr.Vector3([0.0, 0.0, -3.0]), pyrr.Vector3([3.0, 0.0, -4.0]), pyrr.Vector3([-1.0, 0.0, -2.5]) ]
